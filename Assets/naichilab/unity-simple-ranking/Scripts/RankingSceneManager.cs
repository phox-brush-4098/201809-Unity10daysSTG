...
namespace naichilab
{
	...
	{
        // 追加したもの
        [SerializeField] public static bool windowClosed;
        public void SetWindowIsClosed() { windowClosed = true; }
        public void SetWindowIsNoClosed() { windowClosed = false; }
		...
		IEnumerator GetHighScoreAndRankingBoard ()
		{
			...
			//ハイスコア取得
			{
				this.highScoreLabel.text = "connecting...";
				...
				if (hiScoreCheck.Count > 0) {
					...
					this.highScoreLabel.text = s != null ? s.TextForDisplay : "Error";
